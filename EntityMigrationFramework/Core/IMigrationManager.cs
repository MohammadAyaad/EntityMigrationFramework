...
public interface IMigrationManager<TBase>
{
    ...
    /// <exception cref="EntityMigrationFramework.Exceptions.MigrationPathNotFoundException">No valid migration path exists</exception>
    /// <exception cref="EntityMigrationFramework.Exceptions.InvalidMigrationException">Error during migration execution</exception>
